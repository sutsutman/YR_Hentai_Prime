...
namespace YR_Hentai_Prime_AnimationBed
{
    ...
    public class JobDriver_TendVictim : JobDriver
    {
        ...
        protected override IEnumerable<Toil> MakeNewToils()
        {
            ...
            this.FailOn(delegate
            {
                ...
                return (CompAnimationBedTarget != null && CompAnimationBedTarget.containmentMode == EntityContainmentMode.Release) ? true : false;
            });
            ...
            if (usesMedicine)
            {
                yield return JobDriver_TendPatient.FindMoreMedicineToil(pawn, InnerPawn, MedicineUsed, job, reserveMedicine);
            }
